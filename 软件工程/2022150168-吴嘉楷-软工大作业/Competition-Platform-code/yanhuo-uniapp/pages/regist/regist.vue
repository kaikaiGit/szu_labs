<template>
	<view class="container">
		...
		<view class="main">
			<view class="center">
				<input placeholder="输入手机号/邮箱注册" class="info-input" v-model="value" placeholder-style="letter-spacing:2rpx"/>
				<view class="code">
					<input placeholder="验证码输入" class="info-input" v-model="code" placeholder-style="letter-spacing:2rpx"/>
			...
			<view class="regist">
				<tui-button @click="regist" type="primary" shape="circle">注册</tui-button>
			</view>
		</view>
		<view></view>
	</view>
