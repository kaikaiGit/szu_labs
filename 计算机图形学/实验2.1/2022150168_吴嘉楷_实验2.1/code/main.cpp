...
void scroll_callback(GLFWwindow* window, double xoffset, double yoffset)
{
	offsetAngle += yoffset * delta * 10; // 乘以10是为了增加旋转速度
}
**/
...
int main(int argc, char **argv)
{
	...
	// 创建主窗口。
	GLFWwindow* mainwindow = glfwCreateWindow(width, height, "2022150168_吴嘉楷_实验2.1", NULL, NULL);
	if (mainwindow == NULL)
	{
