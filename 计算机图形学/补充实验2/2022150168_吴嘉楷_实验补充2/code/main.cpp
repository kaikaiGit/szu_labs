...
void display()
{
	...
	left_lower_arm(modelMatrix); // 生成左小臂
	...
	left_upper_leg(modelMatrix); // 生成左大腿
	// @TODO: 左小腿
	...
	left_lower_leg(modelMatrix); // 生成左小腿
...
int main(int argc, char **argv)
{
	...
	// 配置窗口属性
	GLFWwindow* window = glfwCreateWindow(700, 700, "2022150168_吴嘉楷_实验补充2", NULL, NULL);
	if (window == NULL)
	{
